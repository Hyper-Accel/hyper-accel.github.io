...
앞서 말씀드렸듯이 TPU는 AI 연산에 특화되어 제작되었습니다. AI 연산 중 가장 큰 특징은 대규모의 행렬곱셈 수행한다는 점인데요. 이는 모델 종류(CNN, RNN, Transformer)에 관계 없이 학습과 추론 과정에서 인공 신경망의 가중치를 사용하고 기타 다른 값들을 연산하는 과정에서 볼 수 있는 공통적인 특징입니다.
