...
{{< figure src="./images/back_book.png" alt="뒷북" caption="" align="center" >}}
...
{{< figure src="./images/ces-map.png" alt="CES 전시회 안내도" width="60%" caption="CES 전시회 안내도" align="center" >}}
...
{{< figure src="./images/ces-timetable.png" alt="안내 PPT 중 일부. CES 타임 테이블" width="60%" caption="안내 PPT 중 일부. CES 타임 테이블" align="center" >}}
...
{{< figure src="./images/kstartup-booth-map.png" alt="안내 PPT 중 일부. 전시회 지도 및 부스 위치" width="60%" caption="안내 PPT 중 일부. 전시회 지도 및 부스 위치" align="center" >}}

{{< figure src="./images/kstartup-supplies.png" alt="안내 PPT 중 일부. 제공되는 물품 리스트" width="60%" caption="안내 PPT 중 일부. 제공되는 물품 리스트" align="center" >}}
...
{{< figure src="./images/hyperaccel-booth-orion.jpeg" alt="1세대 서버인 Orion가 전시된 하이퍼엑셀 부스" width="60%" caption="1세대 서버인 Orion가 전시된 하이퍼엑셀 부스" align="center" >}}

잘 도와주신 덕분에 저희도 처음임에도 불구하고 "참여"보다 "전시"에 집중할 수 있었고, 성공적으로 CES 부스 운영을 마칠 수 있었습니다. 사진 설명을 위해 간단히 회사 소개를 드리면 하이퍼엑셀은 LLM 추론을 위한 차세대 AI 칩을 개발하는 회사로, FPGA 검증을 이미 완료했으며 올해 상반기 중 ASIC 칩을 출시할 예정입니다. 사진에 보이는 서버는 FPGA 기반 1세대 서버입니다.
...
{{< figure src="./images/lg-oled-structure-2.jpeg" alt="LG OLED TV 구조물 내부" width="60%" caption="(2025) LG OLED TV 구조물 내부" align="center" >}}
...
{{< figure src="./images/lg-cloi-robot.png" alt="LG 클로이드 홈 로봇" width="60%" caption="(2026) LG 클로이드 홈 로봇" align="center" >}}
...
{{< figure src="./images/samsung-smarthome-1.jpeg" alt="삼성 스마트홈 부스 1" width="60%" caption="(2025) 삼성 부스 입구" align="center" >}}

{{< figure src="./images/samsung-smarthome-2.jpeg" alt="삼성 스마트홈 부스 2" width="60%" caption="(2025) 삼성 스마트 가전" align="center" >}}
...
{{< figure src="./images/samsung-micro-rgb-tv-1.png" alt="삼성 130형 마이크로 RGB TV" width="60%" caption="(2026) 삼성 130형 마이크로 RGB TV" align="center" >}}

{{< figure src="./images/samsung-smarthome-2026.png" alt="삼성 스마트홈 부스 2026" width="60%" caption="(2026) 삼성 스마트 TV" align="center" >}}
...
{{< figure src="./images/sk-booth-entrance.png" alt="SK 부스 입구" width="60%" caption="(2025) SK 부스 입구" align="center" >}}
...
{{< figure src="./images/sk-hbm-display-1.png" alt="SK HBM 전시 1" width="60%" caption="(2025) SK HBM3E" align="center" >}}

{{< figure src="./images/sk-hbm-display-2.png" alt="SK HBM 전시 2" width="60%" caption="(2025) SK 메모리 라인업" align="center" >}}
...
{{< figure src="./images/sk-hbm4-1.png" alt="SK HBM4 1" width="60%" caption="(2026) SK 전시관 전경" align="center" >}}
...
CES 2025에서 젠슨 황이 말했습니다. AI의 다음 개척 분야는 Physical AI라고. 1년이 지나 CES 2026을 바라보는 지금, AI가 단순히 소프트웨어에 머무르지 않고 물리적인 세계로 확장되고 있다는 점이 가장 눈에 띄었습니다. 대표적으로 LG의 클로이드가 실제 가정에서 활용되는 모습을 보여주었고, 이번 포스트에서는 다루지 않았지만 여러 부스에서 춤을 추거나 일을 하는 로봇을 어렵지 않게 찾아볼 수 있었습니다. 

그리고 CES 2026에서 리사 수가 말했습니다. 전 인류를 위해 수십억 개의 AI 에이전트가 24시간 백그라운드에서 돌아가는 세상이 올 것이라고. 이처럼 AI는 점점 더 인류의 삶에 깊숙이 침투하고 있고, 이러한 수요를 뒷받침하기 위해 NVIDIA의 GPU는 물론이고 SAMSUNG, SK의 HBM4 같은 하드웨어의 발전도 빠르게 이루어지고 있습니다. 이러한 흐름은 앞으로 더 가속화될 것으로 보입니다.
...
{{< figure src="./images/startup.jpg" alt="스타트업 성공 요소" width="60%" caption="스타트업 성공 요소" align="center" >}}

1년 사이에 눈부신 기술 발전을 이루어낸 많은 회사들에 대한 리스펙을 보내며, CES 2027은 하이퍼엑셀의 무대가 되도록 해야겠다는 동기부여와 함께 이만 글 마치겠습니다.
