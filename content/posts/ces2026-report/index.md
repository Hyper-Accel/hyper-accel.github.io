...
위 사진은 작년 SK 전시관 입구인데요, 폭포 속 동굴에 들어가는 듯한 입구는 주변을 압도하고 사람들의 이목을 끌기에 충분하였습니다. 찾아보니 bit를 파도처럼 형상화한 그래픽을 구현하여 메모리 회사임을 나타내었다고 합니다. 그리고 HBM 존재만으로도 이미 세계에서 가장 핫한 주제이기에 정말 많은 사람이 방문하였습니다.
