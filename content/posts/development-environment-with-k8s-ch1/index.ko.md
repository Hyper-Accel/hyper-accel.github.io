...
- 저장소 관리
  ...
  - 관리 편의성 증대 및 네트워크 지연 최소화를 위해 `Rook-Ceph`과 `Harbor`를 도입하여 내부 OCI Registry를 운영하고 있습니다.
  - 사내 PyPi 서버 환경 제공을 위해 `Nexus`를 도입하여 운영하고 있습니다.
...
해당 내용에 관련해서도 글을 통해 소개하도록 하겠습니다!
