...
4. **실전 결과 중심 평가** — 공개 벤치에 없는 **제로데이** (아직 공개되지 않은 취약점)를 찾게 하여 “외워서 푼 것”이 아니라는 것을 검증합니다.
...
숫자만 봐도 개선 폭이 크다는 인상은 받았지만, 저는 낯선 벤치마크보다 [Red Team 글](https://red.anthropic.com/2026/mythos-preview/) 에 담긴 구체적인 사례가 더 많이 와닿았습니다. 이를테면 오랜 기간 안정적으로 서비스 해왔던 여러 프로그램들에게서 취약점을 발견한 것인데요, 제세한 내용은 다음 장에 정리했습니다.
