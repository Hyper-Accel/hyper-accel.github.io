...
> 이번 편부터는 시점을 GPU 바깥, 시스템 레벨로 옮겨서 **CXL** 이 메모리 계층의 어디를 채우는지 살펴봅니다.

## 들어가며

안녕하세요, HyperAccel에서 RTL Designer로 재직 중인 신승빈입니다.

지난 1-3편을 통해 우리는 **GPU 바로 옆의 메모리 계층** 을 깊게 들여다보았습니다. HBM은 DRAM을 쌓아 대역폭을 끌어올렸고, **High Bandwidth Flash(HBF)** 는 NAND에 HBM의 패키징을 입혀 용량을 끌어왔죠.
